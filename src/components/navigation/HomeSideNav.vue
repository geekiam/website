        ...
        <div class="flex w-full max-w-xs p-4">
            <ul class="flex flex-col w-full">
                <li class="my-px">
                    <g-link
                        to="/"
                        class="flex flex-row items-center h-12 px-4 rounded-lg text-green-800 bg-gray-100"
                    >
                        <span
                ...
                <li class="my-px">
                    <span
                        class="flex font-medium text-sm text-green-600 px-4 my-4 uppercase"
                        >Topics</span
                    >
                </li>
                <li class="my-px">
                    ...
                    >
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 50 50"
                                stroke="currentColor"
                                class="h-6 w-6 text-green-800 fill-current"
                            >
                                <path
                ...
                <li class="my-px">
                    ...
                    >
                        <span
                            class="flex items-center justify-center text-lg text-gray-500 hover:text-green-800"
                        >
                            <svg
                                fill="none"
                                stroke-linecap="round"
