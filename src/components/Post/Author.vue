<template>
    <div
        class="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4 mx-auto"
    >
        <g-image
        ...
        />
        <div class="flex items-center px-6 py-3 bg-green-800">
        ...
        <div class="py-4 px-6">
            ...
            <p class="py-2 text-md text-gray-700">{{ details.biography }}</p>
            ...
            >
                ...
                <h1 class="px-2 text-sm">{{ details.location }}</h1>
            </div>
            <div
                class="flex items-center mt-4 text-gray-700"
