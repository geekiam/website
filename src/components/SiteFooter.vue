    ...
    <footer class="bg-green-800 text-white">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
            <div class="mb-8 lg:mb-0">
                ...
                <div class="mb-3">
                    <a class="text-white hover:text-gray-400 font-normal" href="/feed.xml">RSS Feed</a>
                    |
                    <a class="text-white hover:text-gray-400 font-normal" href="/sitemap.xml">Sitemap</a>
                </div>
                <ul class="flex items-center">
                    <li class="mr-8">
                        <a class="text-white hover:text-gray-400" href="mailto:hello@geekiam.co.uk">
                            <svg fill="currentColor" height="20" width="25" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li class="mr-8">
                        <a
                            ...
                            href="https://youtube.com/threenine"
                            target="_blank"
                        >
                            <svg fill="currentColor" height="20" width="26" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li class="mr-8">
                        <a
                            ...
                            target="_blank"
                        >
                            <svg fill="currentColor" height="19" width="20" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li class="mr-8">
                        <a
                            class="text-white hover:text-gray-400"
                            href="https://twitter.com/geek_i_am"
                            target="_blank"
                        >
