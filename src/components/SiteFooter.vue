        ...
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
            <div class="mb-8 lg:mb-0">
                ...
                <div class="mb-3"><p>&copy Copyright {{ new Date().getFullYear() }} . All rights reserved.</p>
                    <p>Developed by <a href="https://threenine.co.uk" class="text-orange-700  border-b border-transparent hover:border-orange-400 transition-border-color">threenine.co.uk</a>
                        with <a href="https://gridsome.org" class="border-b border-transparent hover:border-gray-400 transition-border-color">Gridsome</a> &amp; <a href="https://tailwindcss.com/" class="border-b border-transparent hover:border-gray-400 transition-border-color">Tailwind CSS</a>.</p>

                </div>
                <div class="mb-3">
                    <a href="/feed.xml" class="text-white hover:text-gray-400 font-normal">RSS Feed</a> |
                    <a href="/sitemap.xml" class="text-white hover:text-gray-400 font-normal">Sitemap</a>
                </div>
                <ul class="flex items-center">
                    <li class="mr-8">
                        <a href="mailto:hello@geekiam.co.uk" class="text-white hover:text-gray-400">
                    ...
                    <li class="mr-8">
                        <a href="https://youtube.com/threenine" target="_blank" class="text-white hover:text-gray-400">
                    ...
                    <li class="mr-8">
                        <a href="https://github.com/geekiam" target="_blank" class="text-white hover:text-gray-400">
                    ...
                    <li class="mr-8">
                        <a href="https://twitter.com/geek_i_am" target="_blank" class="text-white hover:text-gray-400">
