<template>
    <layout>
        <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                By using our website and agreeing to this policy, you consent to our use of cookies in accordance with
                the
                terms of this policy.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                Our website incorporates privacy controls which affect how we will process your personal data. By using
                the
                privacy controls, you can specify whether you would like to receive direct marketing communications and
                limit the publication of your information.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                In this policy, “we”, “us” and “our” refer to Three Nine Consulting Limited. For more information about
                us, see
                Section 19.
            </p>
            <h4 class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                include
                your IP address, geographical location, browser type and version, operating system, referral source,
                length
                of visit, page views and website navigation paths, as well as information about the timing, frequency
                and
                pattern of your service use. The source of the usage data is our analytics tracking system. This usage
                data
                may be processed for the purposes of analysing the use of the website and services. The legal basis for
                this
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                address.
                The source of the account data is you or your employer. The account data may be processed for the
                purposes
                of operating our website, providing our services, ensuring the security of our website and services,
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                profile data may include your name, address, telephone number, email address, profile pictures, gender,
                date
                of birth, relationship status, interests and hobbies, educational details and employment details. The
                profile data may be processed for the purposes of enabling and monitoring your use of our website and
                services. The legal basis for this processing is the performance of a contract between you and us and/or
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                data“). The service data may include your name, address, telephone number, email address, profile
                pictures,
                gender, date of birth, relationship status, interests and hobbies, educational details and employment
                details. The source of the service data is you or your employer. The service data may be processed for
                the
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                publication
                and administering our website and services. The legal basis for this processing is consent or the
                performance of a contract between you and us and/or taking steps, at your request, to enter into such a
                contract.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                sending
                you the relevant notifications and/or newsletters. The legal basis for this processing is the
                performance of
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                We may process personal data. This data may include your name, address, telephone number, email address,
                profile pictures, gender, date of birth, relationship status, interests and hobbies, educational details
                and
                employment details. The source of this data is from what you provide and can be augmented from public
                sources. This data may be processed for the purposes of contact information or identify where your
                identity
                may need to be verified to protect our mutual interests. The legal basis for this processing is consent
                or
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                We will use your personal data for the purposes of automated decision-making in relation to routing to
                the
                correct department.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                This automated decision-making will involve simple categorisation based on customer type or selections
                you
                have made.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                The significance and possible consequences of this automated decision-making are to ensure we offer the
                best
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                our
                ultimate holding company and all its subsidiaries) insofar as reasonably necessary for the purposes, and
                on
                the legal basis, set out in this policy.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                We may disclose your personal data to our insurers and/or professional adviser insofar as reasonably
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                We may disclose contact data to our suppliers or subcontractors insofar as reasonably necessary for
                processing orders or engaging with our services.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                Financial transactions relating to our website and services may be handled by our payment services
                providers, Stripe, Paypal. We will share transaction data with our payment services providers only to
                the
                extent necessary for the purposes of processing your payments, refunding such payments and dealing with
                complaints and queries relating to such payments and refund. You can find information about the payment
                services providers’ privacy policies and practices on their respective websites.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                offer,
                market and sell to you relevant goods and/or services. Each such third party will act as a data
                controller
                in relation to the enquiry data that we supply to it; and upon contacting you, each such third party
                will
                supply to you a copy of its own privacy policy, which will govern that third party’s use of your
                personal
                data.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (a) Data you provide will be retained for a minimum period of 90 days following its creation on our
                systems, and
                for an unlimited period if there is a legal requirement.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                In some cases it is not possible for us to specify in advance the periods for which your personal data
                will
                be retained. In such cases, we will determine the period of retention based on the following criteria:
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (a)the period of retention of personal contact data will be determined based on legal requirements e.g.
                tax
                records.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (b) Data you yourself store as contact or profile data on our forums, you can delete this your self by
                updating
                the user record.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                The following personal data will be stored by us in encrypted form where possible: your name, contact
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                computer
                program. You are responsible for keeping the password you use for accessing our website confidential and
                we
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                We may notify you of changes to this policy by email or through the private messaging system on our
                website.
            </p>
            <h4 class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                rights
                are complex, and not all of the details have been included in our summaries. Accordingly, you should
                read
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                they
                were collected or otherwise processed; you withdraw consent to consent-based processing; you object to
                the
                processing under certain rules of applicable data protection law; the processing is for direct marketing
                purposes; and the personal data have been unlawfully processed. However, there are exclusions of the
                right
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                from
                us in a structured, commonly used and machine-readable format. However, this right does not apply where
                it
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                the
                right to withdraw that consent at any time. Withdrawal will not affect the lawfulness of processing
                before
                the withdrawal.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                You may exercise any of your rights in relation to your personal data by written notice to us, in
                addition
                to the other methods specified in this Section 9.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                Where you request access to personal information, we are required by law to use reasonable means to
                verify
                your identity before doing so. The first copy will be provided free of charge. If your requests for
                copies
                are excessive or manifestly unfounded, and in particular if they are of a repetitive nature, we may
                charge a
                reasonable fee to cover administrative costs of providing you with such information or communicating
                with
                you in regard to that information or taking the action requested by you or refusing to act on your
                request.
                This is set out in Article 12 of the GDPR.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            <h4 class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                In respect of hosted services we do not act as a data controller; instead, we act as a data processor.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                Insofar as we act as a data processor rather than a data controller, this policy shall not apply. Our
                legal
                obligations as a data processor are instead set out in the contract between us and the relevant data
                controller.
            </p>
            <h4 class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                web
                browser and will remain valid until its set expiry date, unless deleted by the user before the expiry
                date;
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                personalisation – we use cookies to store information about your preferences and to personalise our
                website
                for you;
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                reflect your interests. To determine your interests, Google will track your behaviour on our website and
                on
                other websites across the web using cookies. You can view, delete or add interest categories associated
                with
                your browser by visiting: https://adssettings.google.com. You can also opt out of the AdSense partner
                ...
                cookies, and if you clear the cookies from your browser your opt-out will not be maintained. To ensure
                that
                an opt-out is maintained in respect of a particular browser, you may wish to consider using the Google
                browser plug-ins available at: https://support.google.com/ads/answer/7395996
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                16.4

                We use Clicky to analyse web traffic. This service uses cookies for tracking site activity. You can view
                the
                privacy policy of this service provider at https://clicky.com/terms
            </p>
            <h4 class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (a) <a href=" https://support.google.com/chrome/answer/95647?hl=en">
                https://support.google.com/chrome/answer/95647?hl=en (Chrome)</a>


            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (b)<a href=" https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences">
                https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences (Firefox)</a>
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (c)<a href="http://www.opera.com/help/tutorials/security/cookies/">http://www.opera.com/help/tutorials/security/cookies/
                (Opera);</a>
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (e)<a href="https://support.apple.com/kb/PH21411">ttps://support.apple.com/kb/PH21411 (Safari); and</a>

                h
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                (f)<a href=" https://privacy.microsoft.com/en-us/windows-10-microsoft-edge-and-privacy">
                https://privacy.microsoft.com/en-us/windows-10-microsoft-edge-and-privacy (Edge).</a>
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                This website is owned and operated by Three Nine Consulting Limited.
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                We are registered in the England & Wales under Registration Number: 05608093 , and our Registered Office
                is
                at 99 Weyhill, Haslemere, Surrey GU 27 1HT
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">

                Our principal place of business is at 35 Salt Spring Drive, Royal Wootton Bassett, Wiltshire, SN4 7SD
            </p>
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
            ...
            <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                Our data protection officer can be contacted via the same contact details stipulated previously
