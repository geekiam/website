<template>
    <layout>
        <template #main-content>
            <div
                class="prose leading-normal text-gray-700 bg-white px-4 py-5 border-b border-gray-200 sm:px-6"
            >
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    In this policy, “we”, “us” and “our” refer to Three Nine
                    Consulting Limited. For more information about us, see
                    Section 19.
                </p>
                <h4
                    class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2"
                >
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    views and website navigation paths, as well as information
                    about the timing, frequency and pattern of your service use.
                    The source of the usage data is our analytics tracking
                    system. This usage data may be processed for the purposes of
                    analysing the use of the website and services. The legal
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    source of the account data is you or your employer. The
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    may include your name, address, telephone number, email
                    ...
                    us and/or taking steps, at you request, to enter into such a
                    contract.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We may process your personal data that are provided in the
                    course of the use of our services (“service data“). The
                    service data may include your name, address, telephone
                    number, email address, profile pictures, gender, date of
                    birth, relationship status, interests and hobbies,
                    educational details and employment details. The source of
                    the service data is you or your employer. The service data
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    services. The legal basis for this processing is consent or
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We may process personal data. This data may include your
                    name, address, telephone number, email address, profile
                    pictures, gender, date of birth, relationship status,
                    interests and hobbies, educational details and employment
                    details. The source of this data is from what you provide
                    and can be augmented from public sources. This data may be
                    processed for the purposes of contact information or
                    identify where your identity may need to be verified to
                    protect our mutual interests. The legal basis for this
                    processing is consent or the performance of a contract
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We will use your personal data for the purposes of automated
                    decision-making in relation to routing to the correct
                    department.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    This automated decision-making will involve simple
                    categorisation based on customer type or selections you have
                    made.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    The significance and possible consequences of this automated
                    decision-making are to ensure we offer the best service to
                    our customers.
                </p>
                <h4
                    class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2"
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    basis, set out in this policy.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We may disclose your personal data to our insurers and/or
                    professional adviser insofar as reasonably necessary for the
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We may disclose contact data to our suppliers or
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    may be handled by our payment services providers, Stripe,
                    ...
                    such payments and refund. You can find information about the
                    payment services providers’ privacy policies and practices
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (a) Data you provide will be retained for a minimum period
                    of 90 days following its creation on our systems, and for an
                    unlimited period if there is a legal requirement.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (a)the period of retention of personal contact data will be
                    determined based on legal requirements e.g. tax records.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (b) Data you yourself store as contact or profile data on
                    our forums, you can delete this your self by updating the
                    user record.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    encrypted form where possible: your name, contact
                    information, password(s) and cardholder data.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Data relating to your enquiries and financial transactions
                    that is sent from your web browser to our web server, or
                    from our web server to your web browser, will be protected
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    You should ensure that your password is not susceptible to
                    being guessed, whether by a person or a computer program.
                    You are responsible for keeping the password you use for
                    accessing our website confidential and we will not ask you
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    In this Section 9, we have summarised the rights that you
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    your personal data is: (a) consent; or
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (b) that the processing is necessary for the performance of
                    a contract to which you are party or in order to take steps
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    ...
                    other methods specified in this Section 9.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Where you request access to personal information, we are
                    required by law to use reasonable means to verify your
                    identity before doing so. The first copy will be provided
                    free of charge. If your requests for copies are excessive or
                    manifestly unfounded, and in particular if they are of a
                    repetitive nature, we may charge a reasonable fee to cover
                    administrative costs of providing you with such information
                    or communicating with you in regard to that information or
                    taking the action requested by you or refusing to act on
                    your request. This is set out in Article 12 of the GDPR.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1"></p>
                <h4
                    class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2"
                >
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Our website and services are targeted at persons over the
                    age of 18.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    In respect of hosted services we do not act as a data
                    controller; instead, we act as a data processor.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Insofar as we act as a data processor rather than a data
                    controller, this policy shall not apply. Our legal
                    obligations as a data processor are instead set out in the
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (c) shopping cart – we use cookies to maintain the state of
                    your shopping cart as you navigate our website;
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (d) personalisation – we use cookies to store information
                    about your preferences and to personalise our website for
                    you;
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (e) security – we use cookies as an element of the security
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (f) advertising – we use cookies to help us to display
                    advertisements that will be relevant to you;
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (g) analysis – we use cookies to help us to analyse the use
                    and performance of our website and services; and
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    (h) cookie consent – we use cookies to store your
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    16.1 Our service providers use cookies and those cookies may
                    be stored on your computer when you visit our website.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    16.2 We use Google Analytics to analyse the use of our
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    16.3 We publish Google AdSense interest-based advertisements
                    on our website. These are tailored by Google to reflect your
                    interests. To determine your interests, Google will track
                    your behaviour on our website and on other websites across
                    the web using cookies. You can view, delete or add interest
                    categories associated with your browser by visiting:
                    https://adssettings.google.com. You can also opt out of the
                    AdSense partner network cookie using those settings or using
                    the Network Advertising Initiative’s multi-cookie opt-out
                    mechanism at: http://optout.networkadvertising.org. However,
                    these opt-out mechanisms themselves use cookies, and if you
                    clear the cookies from your browser your opt-out will not be
                    maintained. To ensure that an opt-out is maintained in
                    respect of a particular browser, you may wish to consider
                    using the Google browser plug-ins available at:
                    https://support.google.com/ads/answer/7395996
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    16.4 We use Clicky to analyse web traffic. This service uses
                    cookies for tracking site activity. You can view the privacy
                    policy of this service provider at https://clicky.com/terms
                </p>
                <h4
                    class="text-lg leading-6 font-medium text-gray-900 mb-2 mt-2"
                >
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    This website is owned and operated by Three Nine Consulting
                    Limited.
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    We are registered in the England & Wales under Registration
                    Number: 05608093 , and our Registered Office is at 99
                    Weyhill, Haslemere, Surrey GU 27 1HT
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Our principal place of business is at 35 Salt Spring Drive,
                    Royal Wootton Bassett, Wiltshire, SN4 7SD
                </p>
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    You can contact us:
                </p>
                ...
                <p class="mt-1 text-sm leading-5 text-gray-800 mb-1">
                    Our data protection officer can be contacted via the same
                    contact details stipulated previously
                </p>
            </div>
        </template>
    </layout>
