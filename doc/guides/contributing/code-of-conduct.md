...
The Geek.I.Am project has a [Code of Conduct][] that *all* contributors are
expected to follow. This code describes the *minimum* behavior expectations
for all contributors.

As a contributor to Geek.I.Am, how you choose to act and interact towards your
...
All contributors to Geek.I.Am tacitly agree to abide by both the letter and
...
The over arching policy for contributors to adhere and follow is simple:

**Don't be a dick!**


[Code of Conduct]: https://github.com/threenine/geekiam/blob/master/CODE_OF_CONDUCT.md
