...
respository.  These could be files that could be generated by your project at run time or output from various processes. 
 Integrated Development Environments (IDE) and Operating Systems (OS)  also generate hidden files and system generated 
 file which should also be excluded from respositories. 
...
[Git is a popular version control system](https://geekiam.io/what-is-git/ "What is git") provides the ability to create
...
[WebStorm](https://www.jetbrains.com/webstorm/ "Webstorm - The smartest JavaScript IDE"), [Rider](https://www.jetbrains.com/rider/ "Rider Fast & powerful, cross-platform .NET IDE"), [PHPStorm](https://www.jetbrains.com/phpstorm/ "PhpStorm The Lightning-Smart PHP IDE"), [GoLand](https://www.jetbrains.com/go/ "Goland cross-platform IDE built specially for Go developers")  etc.
  on Linux based computers.  So typically use the defaults that are provided in [Jetbrains Ignore](https://github.com/github/gitignore/blob/master/Global/JetBrains.gitignore) and the [Linux Ignore](https://github.com/github/gitignore/blob/master/Global/Linux.gitignore) 
...
reason for this is there is a high chance they they will get out of sync with their source, they are not necessary and they 
they are always re-generated anyway.

Temporary files and by-products specific to a users tool chain, should also not be included as tracked files.
